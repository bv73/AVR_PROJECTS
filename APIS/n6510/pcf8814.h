// PCF8814 Header by (R)soft

#define PIN_SCLK    PORTB_Bit7 // Clock Data
#define DDR_SCLK    DDRB_Bit7
#define PIN_SDIN    PORTB_Bit6 // Serial Data Input
#define DDR_SDIN    DDRB_Bit6
#define PIN_RST     PORTC_Bit3 // Reset LCD этот бит нужно подключать к контроллеру
#define DDR_RST     DDRC_Bit3
