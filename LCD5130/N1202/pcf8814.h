...
// Стандартный порт - PORTA
// Другие порты - PORTB, PORTC, PORTD, PORTF
// PORTE нельзя из-за кнопок

#define PIN_RST     PORTB_Bit5 // Reset LCD этот бит нужно подключать к контроллеру
#define DDR_RST     DDRB_Bit5
#define PIN_SCLK    PORTB_Bit6 // Clock Data
#define DDR_SCLK    DDRB_Bit6
#define PIN_SDIN    PORTB_Bit7 // Serial Data Input
#define DDR_SDIN    DDRB_Bit7
