...
extern void GLCD_displayChar    (unsigned int ln, unsigned int col, unsigned int  c);
extern void GLCD_displayStringLn(unsigned int x,unsigned int y,unsigned char *s,unsigned int color,unsigned int xcolor);
...
extern       void Set_Wingdows (unsigned int startx,unsigned int starty,unsigned int endx,unsigned int endy)  ;
extern	   void DrawBlock (unsigned int startx,unsigned int starty,unsigned int endx,unsigned int endy,unsigned int color) ;
