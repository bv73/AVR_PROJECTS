...
/*
  ili9481_wr_cmd (ILI9481_COLUMN_ADDRESS_SET); // Set column address
  ...
  ili9481_wr_cmd (ILI9481_PAGE_ADDRESS_SET); // Set page address
...
/*
ILI9481_wr_cmd(ILI9481_FRAME_MEM_ACCESS_AND_INTERF_SET);
ILI9481_wr_dat(0x00);
ILI9481_wr_dat(0x00);
ILI9481_wr_dat(0x00);
ILI9481_wr_dat(0x11);
