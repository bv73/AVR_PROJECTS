...
void main( void )
{
  ...
  pcf8833_pixel(128,60,WHITE);
  pcf8833_pixel(1,130,WHITE);
  pcf8833_pixel(130,60,WHITE);
...
*/
  ...
  id2=id>>8;
  id3=id&0xFF;
  sprintf(LN5,"ID=%02X%02X%02X",id1,id2,id3);

  id1=pcf8833_read_id(P_RDID1);
  id2=pcf8833_read_id(P_RDID2);
  id3=pcf8833_read_id(P_RDID3);
  sprintf(LN6,"ID1=%02X",id1);
  sprintf(LN7,"ID2=%02X",id2);
  sprintf(LN8,"ID3=%02X",id3);
