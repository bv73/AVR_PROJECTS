...
//#define PIN_CSN      PORTD_Bit4 // Chip Select Bit
//#define DDR_CSN      DDRD_Bit4
#define PIN_SCL     PORTD_Bit0 // Serial Clock
#define DDR_SCL     DDRD_Bit0
#define PIN_SI      PORTD_Bit1 // Serial Data Input
#define DDR_SI      DDRD_Bit1
#define PIN_RESN    PORTD_Bit2 // /Reset LCD Driver
#define DDR_RESN    DDRD_Bit2

// бит на ввод -> подтяжка внешними резисторами к VCC
// бит на вывод -> устанавливается 0 (задается при инициализации)
//#define CSN_1  DDR_CSN=0
//#define CSN_0  DDR_CSN=1
#define SCL_1 DDR_SCL=0
#define SCL_0 DDR_SCL=1
#define SI_1  DDR_SI=0
#define SI_0  DDR_SI=1
#define RESN_1 DDR_RESN=0
#define RESN_0 DDR_RESN=1
