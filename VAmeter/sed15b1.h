...
#define PIN_SCL     PORTB_Bit5 // Serial Clock
#define DDR_SCL     DDRB_Bit5
#define PIN_SI      PORTB_Bit4 // Serial Data Input
#define DDR_SI      DDRB_Bit4
#define PIN_RESN    PORTB_Bit3 // /Reset LCD Driver
#define DDR_RESN    DDRB_Bit3
...
#define SED15B1_PIXELX  (96)
#define SED15B1_PIXELY  (65)
#define SED15B1_ROW     (8) // Количество строк
#define SED15B1_COL     (16) // Количество символов в строке (font5x7)
